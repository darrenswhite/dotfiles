...
- 6. When a legend attacks, cards are sent from top of the deck to the adrenaline stack 

equal to the Legend’s base adrenaline. 

- 7. Discarded cards are sent to the adrenaline stack, unless otherwise stated. 

- 8. When adrenaline is used, move an equal amount of cards from the Adrenaline Stack 

to the Void face down, from the top of the stack. 

- Cards 

- 1. Retaliation cards can be played as a reaction to opponents’ cards. 

- 2. Equipment cards can be “attached” to Legends to benefit them, these cards can be 

identified by their durability value. 

- 3. Damage cards can use adrenaline to deal damage to the opponent’s Legend or their 

equipment. 

“Protective” equipment MUST be targeted by an opponent’s Legend’s attacks. 
...
- 7. Cards will have a rarity. These include, in ascending order; ​Pearl​, ​Emerald​, ​Ruby​, 
